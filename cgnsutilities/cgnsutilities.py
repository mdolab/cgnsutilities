            ...
            for line in f:
                if line.strip() and line[0] != "#":
                    ...
                    if len(aux) > 4:
                        ...
                        DirNeu = aux[6]
                        bocoDataSet = BocoDataSet(bocoSetName, bocoDataSetType.lower())
...
class Block(object):
    ...
    def overwriteBCs(self, face, bocoType, family, dataSet):
        ...
        self.addBoco(Boco("boco_%d" % self.bocoCounter, bocoType.lower(), ptRange, family, dataSet))
        self.bocoCounter += 1
...
def isWall(bc):
    ...
    if (
        bc == "bcwall"
        or bc == "bcwallinviscid"
        or bc == "bcwallviscous"
        or bc == "bcwallviscousheatflux"
        or bc == "bcwallviscousisothermal"
    ):
        return True
    else:
        return False
        ...
        for iBoco in range(1, nBoco + 1):
            ...
            if nDataSets != 0:
                ...
                for iBocoDataSet in range(1, nDataSets + 1):
                    ...
                    def getBocoDataSetArray(bcTypeFlag, iDir):
                        ...
                        (
                            ...
                            inFile, iBlock, iBoco, iBocoDataSet, iDir, bcTypeFlag
                        )
                        ...
                        libcgns_utils.utils.getbcdataarray(
                            inFile, iBlock, iBoco, iBocoDataSet, iDir, bcTypeFlag, dataArr, nDataArr
                        )
